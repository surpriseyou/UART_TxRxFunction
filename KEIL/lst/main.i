...
void SYS_Init(void)
{
    ...
    ((SYS_T *) ((0x40000000UL) + 0x00000))->GPD_MFPL |= ((3ul << (0)) | (3ul << (4)));
		...
		((SYS_T *) ((0x40000000UL) + 0x00000))->GPB_MFPL &= ~((0xful << (0)) | (0xful << (4)));
    ((SYS_T *) ((0x40000000UL) + 0x00000))->GPB_MFPL |= ((4ul << (8)) | (4ul << (12)));

}
void UART1_Init()
{
	SYS_ResetModule(((0x4<<24) | (17) ));
	UART_Open(((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000)), 115200);
}
void UART0_Init()
{
...
void UART_TEST_HANDLE()
{
    ...
    if(u32IntSts & (0x1ul << (9)))
    {
        ...
        if(g_u32comRhead != tmp)
        {
            ...
            ((((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000)))->DAT = (u8InChar));
...
void UART1_TEST_HANDLE()
{
    ...
    uint32_t u32IntSts1 = ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000))->INTSTS;

    if(u32IntSts1 & (0x1ul << (8)))
    {
        printf("\nInput:");
        ...
        while((((((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000)))->INTSTS & (0x1ul << (0)))>>(0)))
        {
            ...
            u8InChar1 = ((((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000)))->DAT);    
            ...
            if(g_u32comRbytes1 < 1024)
            {
                 
                g_u8RecData1[g_u32comRtail] = u8InChar1;
                g_u32comRtail1 = (g_u32comRtail1 == (1024 - 1)) ? 0 : (g_u32comRtail1 + 1);
                g_u32comRbytes1++;
            }
        }
        printf("\nTransmission Test:");
    }
    if(u32IntSts1 & (0x1ul << (9)))
    {
        uint16_t tmp;
        tmp = g_u32comRtail1;
        if(g_u32comRhead1 != tmp)
        {
            ...
            while((((((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000)))->FIFOSTS & (0x1ul << (23)))>>(23)));   
            ((((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000)))->DAT = (u8InChar1));
            g_u32comRhead1 = (g_u32comRhead1 == (1024 - 1)) ? 0 : (g_u32comRhead1 + 1);
            g_u32comRbytes1--;
        }
    }
}
...
void UART_FunctionTest()
{
    ...
    UART_EnableInt(((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000)), ((0x1ul << (0)) | (0x1ul << (1)) | (0x1ul << (4))));
	  UART_EnableInt(((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000)), ((0x1ul << (0)) | (0x1ul << (1)) | (0x1ul << (4))));
    while(g_bWait);

     
    UART_DisableInt(((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000)), ((0x1ul << (0)) | (0x1ul << (1)) | (0x1ul << (4))));
		UART_DisableInt(((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000)), ((0x1ul << (0)) | (0x1ul << (1)) | (0x1ul << (4))));
    g_bWait = 1;
